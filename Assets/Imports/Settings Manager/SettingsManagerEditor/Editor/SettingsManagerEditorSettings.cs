...
namespace BattlePhaze.SettingsManager
{
    public static class SettingsManagerEditorSettings
    {
		...
		{
            EditorGUILayout.BeginHorizontal();
            GUILayout.Label("Debug", SettingsmanagerStyle.DescriptorStyling);
            SettingsManager.Instance.ManagerSettings.debug = EditorGUILayout.Toggle(string.Empty, SettingsManager.Instance.ManagerSettings.debug);
			EditorGUILayout.EndHorizontal();
		}
